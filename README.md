# cosmic-builder
A simple project to explore 3D visualization and customization.
...
-Interactive viewing and adjustments
-Built using a simple Streamlit interface

What I learned:
-How 3D objects are structured (sphere-based modeling)
-Handling user input for real-time updates
-Connecting backend logic with visual output
-Limitations of lightweight frameworks for 3D work
